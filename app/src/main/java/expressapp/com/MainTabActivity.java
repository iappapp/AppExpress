...
public class MainTabActivity extends FragmentActivity {
	...
	// 定义数组来存放Fragment界面
	private Class fragmentArray[] = { MainActivity.class, MyExpressActivity.class, ExpressDataBase.class,
	...
	// Tab选项卡的文字
	private String mTextviewArray[] = { "快递", "收藏", "代收", "查询" };
	...
	private View getTabItemView(int index) {
		...
		ImageView imageView = (ImageView) view.findViewById(R.id.imageViewTab);
